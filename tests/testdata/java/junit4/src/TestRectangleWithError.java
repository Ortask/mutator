...
public class TestRectangleWithError  
{
  ...
  @Test
	...
	public void OneRectangle()
	{
		...
		org.junit.Assert.assertEquals( solution.arrangement, RectangleNoCommentsWithError_mutated.Arrangement.NONE );
		org.junit.Assert.assertEquals( RectangleNoCommentsWithError_mutated.RectangleType.SINGLETON, solution.rectangleType ); 
	}
  ...
  @Test
	public void TwoRectangles()
	{
		...
		org.junit.Assert.assertEquals( RectangleNoCommentsWithError_mutated.Arrangement.NONE, solution.arrangement);
		org.junit.Assert.assertTrue(solution.pos_x == 0.0);
		org.junit.Assert.assertTrue(solution.pos_y == 0.0);
		...
		org.junit.Assert.assertTrue( RectangleNoCommentsWithError_mutated.Arrangement.SHORT == r1.arrangement );
		org.junit.Assert.assertTrue( RectangleNoCommentsWithError_mutated.Arrangement.SHORT == r2.arrangement );
	...
	public void ThreeRectangles()
	{
		...
		org.junit.Assert.assertTrue( RectangleNoCommentsWithError_mutated.Arrangement.SHORT == r1.arrangement );
		org.junit.Assert.assertTrue( RectangleNoCommentsWithError_mutated.Arrangement.SHORT == r2.arrangement );
		org.junit.Assert.assertTrue( RectangleNoCommentsWithError_mutated.Arrangement.SHORT == r3.arrangement );
