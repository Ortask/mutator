...
// This file has a syntax error that will make its test suite
// fail.

public class RectangleNoCommentsWithSyntaxError 
{
	public float longest_side;
	public float shortest_side;
	public float pos_x;
	public float pos_y                                    // <--- here
	public RectangleNoCommentsWithSyntaxError rectangle1;
	public RectangleNoCommentsWithSyntaxError rectangle2;
	
	public List<RectangleNoCommentsWithSyntaxError> solution;
	...
	protected void setSidesCorrectly(float side1, float side2)
	{
		if( (side1 <= 0) || (side2 <= 0))
		{
			throw new UnsupportedOperationException("Can't create RectangleNoCommentsWithSyntaxError with dimentions (" + side1 + ", " + side2 + ")");
		}
	...
	public RectangleNoCommentsWithSyntaxError(float side1, float side2)
	{
	...
	public RectangleNoCommentsWithSyntaxError(
			float side1, 
			float side2, 
	...
	public RectangleNoCommentsWithSyntaxError(RectangleNoCommentsWithSyntaxError r)
	{
	...
	public List<RectangleNoCommentsWithSyntaxError> getRectangles() 
	{
		solution = new ArrayList<RectangleNoCommentsWithSyntaxError>();
		getRectangles(this);
		return solution;
	}
	...
	public void getRectangles(RectangleNoCommentsWithSyntaxError root) 
	{
	...
	static public List<RectangleNoCommentsWithSyntaxError> TwoD_CLPUC(final List<RectangleNoCommentsWithSyntaxError> rectangles)
	{
		...
		{
			RectangleNoCommentsWithSyntaxError composite = ARMUS(rectangles.get(0), rectangles.get(1));
			List<RectangleNoCommentsWithSyntaxError> newResult = new ArrayList<RectangleNoCommentsWithSyntaxError>();
			newResult.add(composite);
			return newResult;
		}
		else
		{
			List<RectangleNoCommentsWithSyntaxError> half1 = new ArrayList<RectangleNoCommentsWithSyntaxError>();
			List<RectangleNoCommentsWithSyntaxError> half2 = new ArrayList<RectangleNoCommentsWithSyntaxError>();
	...
	private static void updatePosition(RectangleNoCommentsWithSyntaxError root)
	{
	...
	private static void updatePositionWorkhorse(RectangleNoCommentsWithSyntaxError rect, float x, float y)
	{
		if(rect == null)
		{
			return;
	...
	private static RectangleNoCommentsWithSyntaxError ARMUS(RectangleNoCommentsWithSyntaxError r1, RectangleNoCommentsWithSyntaxError r2)
	{
		...
		RectangleNoCommentsWithSyntaxError solution = new RectangleNoCommentsWithSyntaxError(longestSideForSolution, shortestSideForSolution);
