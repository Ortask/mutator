...
public class TestRectangle extends TestCase 
{
	...
	public void test_1Rectangle()
	{
		...
		assertEquals( solution.arrangement, RectangleNoComments_mutated.Arrangement.NONE );
		assertEquals( RectangleNoComments_mutated.RectangleType.SINGLETON, solution.rectangleType ); 
	}
	...
	public void test_2Rectangles()
	{
		...
		assertEquals( RectangleNoComments_mutated.Arrangement.NONE, solution.arrangement);
		assertTrue(solution.pos_x == 0.0);
		assertTrue(solution.pos_y == 0.0);
		...
		assertTrue( RectangleNoComments_mutated.Arrangement.SHORT == r1.arrangement );
		assertTrue( RectangleNoComments_mutated.Arrangement.SHORT == r2.arrangement );
	...
	public void test_3Rectangles()
	{
		...
		assertTrue( RectangleNoComments_mutated.Arrangement.SHORT == r1.arrangement );
		assertTrue( RectangleNoComments_mutated.Arrangement.SHORT == r2.arrangement );
		assertTrue( RectangleNoComments_mutated.Arrangement.SHORT == r3.arrangement );
